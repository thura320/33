...
''',reply_markup=keyboard)
		...
		''',reply_markup=keyboard)
			...
			return
		keyboard = types.InlineKeyboardMarkup()
		contact_button = types.InlineKeyboardButton(text=f"🏴‍☠️ Stripe Charge 1$🏴‍☠️",callback_data='br')
...
𝗕𝗼𝘁 𝗕𝘆: chk1212</b>'''
					if "insufficient funds" in last or 'Thank you for you purchase' in last or 'result' in last or 'Thank You' in last or 'thank-you-for-your-support' in last or 'thank you' in last:
						live += 1
